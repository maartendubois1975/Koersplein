...
const configs={
 ...
 XETR:{urls:['https://www.cashmarket.deutsche-boerse.com/resource/blob/1528/af989488137748597dc6d93559498276/data/t7-xetr-allTradableInstruments.csv'],allowedMics:new Set(['XETR']),market:/Xetra|XETR/i,min:500,format:'xetra'},
...
if(mic==='XETR'){
 ...
 const header=parse(lines[0]); const norm=s=>String(s||'').toLowerCase().replace(/[^a-z0-9]+/g,''); const hn=header.map(norm);
