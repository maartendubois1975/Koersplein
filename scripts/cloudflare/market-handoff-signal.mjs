...
async function inspect(m){
 ...
 return {catalogFingerprint:raw.fingerprint||null,catalog:shares.length,checked,complete,missing,invalid,latestExpectedTradingDate,ready:shares.length>0&&checked===shares.length&&complete===shares.length&&missing===0&&invalid===0};
}
